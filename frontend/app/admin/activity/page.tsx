...
import { useAuditLog, downloadAuditLogCsv } from "@/hooks/useAdmin";
import {
  AuditLogDesktopTable,
  AuditLogMobileList,
} from "@/components/features/admin/AuditLogViews";
...
const ACTION_FILTERS: { value: string | undefined; label: string }[] = [
  ...
  { value: "password_reset_request", label: "Recuperación solicitada" },
  { value: "admin_password_reset", label: "Contraseña temporal" },
  { value: "admin_reject_password_reset", label: "Recuperación rechazada" },
  ...
  { value: "challenge_limit_denied", label: "Límite de retos" },
  ...
  { value: "extra_bet_cancelled_unpaid", label: "Extra cancelado (no pagó)" },
  { value: "admin_repair_unpaid_extra_cancellations", label: "Reparar extras cancelados" },
  ...
  { value: "admin_marquee_update", label: "Marquesina promocional" },
...
const ACTION_COLORS: Record<string, string> = {
  ...
  challenge_limit_denied: "bg-amber-500/20 text-amber-300",
  ...
  extra_bet_cancelled_unpaid: "bg-red-500/20 text-red-300",
  admin_repair_unpaid_extra_cancellations: "bg-amber-500/20 text-amber-300",
  ...
  admin_marquee_update: "bg-accent/20 text-accent",
