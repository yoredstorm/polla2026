  ...
  return (
    <Modal open onClose={onClose} title="Ingresar Resultado" size="md">
        ...
        <div className="flex gap-3">
          ...
          >
            {settle.isPending ? "Liquidando..." : "Guardar y Liquidar"}
          </button>
        </div>
...
export default function AdminFixturesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {settleModal && <SettleModal fixture={settleModal} onClose={() => setSettleModal(null)} />}
      {editModal && <EditModal fixture={editModal} onClose={() => setEditModal(null)} />}
    </div>
  );
}
